...
class TestModel(TestCase):
    ...
    def test_char_fields(self):
        fields = [
            { "field": "aufnr", "verbose": "AUFNR", "max_length": 12, "is_null": False, "value": "sample"},
            { "field": "matnr", "verbose": "MATNR", "max_length": 18, "is_null": True, "value": None },
            { "field": "dwerk", "verbose": "DWERK", "max_length": 4, "is_null": True, "value": None }
        ]
...
class TestView(TestCase):
    ...
    def setUp(self):
        ...
        self.qrcode = Qrcode.objects.using('qr').create(aufnr = "sample", matnr = "00001")
    ...
    def test_get_qrcode(self):
        ...
        response = self.client.get(reverse('item-code'), { "code": "sample" }, **auth_header)
